	...
	public org.eclipse.jdt.core.dom.CompilationUnit makeConsistent(CompilationUnit workingCopy) throws JavaModelException {
		...
		try {
			...
			if (JavaProject.hasJavaNature(workingCopy.getJavaProject().getProject())
				...
				ICompilationUnitResolver unitResolver = CompilationUnitResolverDiscovery.getInstance();
				var createdAST = unitResolver.findProblems(
						source,
				...
				if (this.astLevel != ICompilationUnit.NO_AST && createdAST != null) {
					this.ast = createdAST;
				}
				if (this.ast != null) {
