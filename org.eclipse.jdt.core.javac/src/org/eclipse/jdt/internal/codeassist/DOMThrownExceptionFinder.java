...
public class DOMThrownExceptionFinder extends ASTVisitor {
	...
	public boolean visit(MethodInvocation node) {
		visitMethodInvocation(node.resolveMethodBinding());
		return super.visit(node);
	}

	@Override
	public boolean visit(ClassInstanceCreation node) {
		visitMethodInvocation(node.resolveConstructorBinding());
		return super.visit(node);
	}
	...
	private void visitMethodInvocation(IMethodBinding methodBinding) {
